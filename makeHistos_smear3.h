...
//check this tomorrow Austin!
	   ...
	   //TH1D *hjr = NULL;
           ...
           TH1D *hjr = (TH1D*) root_histogram_data5tevmb_jet->Clone("hjr");
           TH1D *hjr1 = (TH1D*) root_histogram_data5tev40_jet->Clone("hjr1");
           TH1D *hjr2 = (TH1D*) root_histogram_data5tev80_jet->Clone("hjr2");

           hjr->Scale(33.514*34.990);
           hjr1->Scale(34.99);
           hjr->Add(hjr1);
           hjr->Add(hjr2);
           ...
           TH1D *hj = (TH1D*) hjr->Clone("hj");

	   if (perp_jet < 80) {
		   hj->Scale(1/(33.514*34.99));
		   ht = root_histogram_data5tevmb_track;
		   hts = root_histogram_data5tevmb_track_reflected;
		   hjr->Scale(1/(33.514*34.99));
	   }
	   else if (perp_jet < 140) {
		   hj->Scale(1/34.99);
		   ht = root_histogram_data5tev40_track;
...
/////////////////////////////////////////////////////////////////////
   ...
   for (size_t i = 0; i < 5; i++) {
	   ...
	   root_histogram_data_5tev_temp[index_perp_jet]->GetXaxis()->SetRangeUser(0.5, 95);
	   ...
	   root_histogram_ratio_track[i]->GetXaxis()->SetRangeUser(0.5, 95);
   ...
   leg->AddEntry((TObject*)0, "5% Jet p_{T} smearing","");
   leg->Draw();
