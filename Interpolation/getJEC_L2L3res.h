...
double getJEC_L2L3res(const char * mode, double jetPt)
{
  ...
  //2014 Winter L2L3 Residual Correction
    ...
    correction *= 1./(0.9773-0.0442*100./3.*(max(0.0,1.03091-0.051154*pow(x,-0.154227))-max(0.0,1.03091-0.051154*pow(208.0,-0.154227)))-0.090*((-2.36997+0.413917*log(x))/x-(-2.36997+0.413917*log(208.0))/208));
