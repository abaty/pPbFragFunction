...
const char* filePath = "tempRootFiles/processed_2015_04_08__18_50_31/";
...
TH1D ** pPb5Pbp5TeV_recoMC_interp[FF_Bins];
TH1D ** pPb5Pbp5TeV_genMC_interp[FF_Bins];
TH1D ** pPb5Pbp5TeV_rJgTMC_interp[FF_Bins];
TH1D ** pPb5Pbp5TeV_gJrTMC_interp[FF_Bins];
...
TH1D * pPb5Pbp5TeV_recoMC[FF_Bins];
...
TH1D * pPb5Pbp5TeV_recoMC_Q[FF_Bins];
...
TH1D * pPb5Pbp5TeV_recoMC_G[FF_Bins];
...
TH1D * pPb5Pbp5TeV_genMC[FF_Bins];
...
TH1D * pPb5Pbp5TeV_genMC_Q[FF_Bins];
...
TH1D * pPb5Pbp5TeV_genMC_G[FF_Bins];
...
TH1D * pPb5Pbp5TeV_rJgTMC[FF_Bins];
...
TH1D * pPb5Pbp5TeV_gJrTMC[FF_Bins];
...
TH1D * pPbPbp_FF_recoMC[FF_Bins];
TH1D * pPbPbp_FF_genMC[FF_Bins];
TH1D * pPbPbp_FF_rJgTMC[FF_Bins];
TH1D * pPbPbp_FF_gJrTMC[FF_Bins];
...
void loadHistos(int v, int UEtype)
{
  ...
  if(v==1 || v==2 || v==7 || v==10 || v==13 || v==14 || v==15 || v==20 || v==21 || v==26) pp2Tag = variationTag[v];
  if(v==3 || v==4 || v==8 || v==11 || v==13 || v==16 || v==17 || v==22 || v==23 || v==26) pp7Tag = variationTag[v];
  if(v==5 || v==6 || v==9 || v==12 || v==13 || v==18 || v==19 || v==24 || v==25 || v==26) pPb5Tag = variationTag[v];
