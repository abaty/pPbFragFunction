...
void turnOnCurve(int mode = 0)
{
  ...
  TH1D * turnon40 = new TH1D("turnon40","",100,0,200);
  TH1D * turnon80 = new TH1D("turnon80","",100,0,200);
  TH1D * turnon30 = new TH1D("turnon30","",100,0,200);
  TH1D * turnon60 = new TH1D("turnon60","",100,0,200);
  TH1D * turnon110 = new TH1D("turnon110","",100,0,200);

  TH1D * denom = new TH1D("denom","",100,0,200);
  ...
  if(mode !=2)
  {
    turnon40->Divide(denom);
    turnon40->Draw();

    turnon80->Divide(denom);
    turnon80->SetMarkerColor(kRed+1);
    turnon80->Draw("same");
  }
  else
  {
