...
{  
  ...
  { 
    ...
    if(i==0) tlat->DrawLatex(2,2,"30.9 nb^{-1} (5.02 TeV pPb)");
    if(i==5) tlat->DrawLatex(2,2,"5.3 pb^{-1} (2.76 TeV pp)");
    if(i==5) tlat->DrawLatex(4.5,0.75,"2.5 fb^{-1} (7 TeV pp)");
    ...
    if(i==2) tlat->DrawLatex(20,2,"ak3PF jets");
    if(i==3) tlat->DrawLatex(20,2,"|#eta_{CM}^{jet}|<1.5");
    if(i==4) tlat->DrawLatex(8,2,"CMS Preliminary");

    if(i==10) tlat->DrawLatex(1,2.4,"30.9 nb^{-1} (5.02 TeV pPb)");
    if(i==10) tlat->DrawLatex(1,2.6,"5.3 pb^{-1} (2.76 TeV pp)");
    if(i==10) tlat->DrawLatex(1,2.2,"2.5 fb^{-1} (7 TeV pp)");
    if(i==12) tlat->DrawLatex(1,2.6,"ak3PF jets");
    if(i==13) tlat->DrawLatex(1,2.6,"|#eta_{CM}^{jet}|<1.5");
    if(i==14) tlat->DrawLatex(1,2.6,"CMS Preliminary");    
    ...
    if(i==0)
    {
      TLegend * leg = new TLegend(0.35,0.25,0.6,0.5);
